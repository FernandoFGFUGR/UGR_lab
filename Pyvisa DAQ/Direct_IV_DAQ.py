...
for i in range(ntest):
    ...
    #Pausa para iniciar
    print('Pulse intro para empezar prueba ' + str(i) + ' : ')
    ntest=input()
    ...
    with open(path + name + '_set_data_direct.txt', 'a+') as f:
...
plt.xlabel("Volts")
plt.ylabel("mAmperes")
if os.path.isfile(path + name + '_set_plot_direct.png'):
   os.remove(path + name + '_set_plot_direct.png') 
plt.savefig(path + name + '_set_plot_direct.png')
#plt.show()
