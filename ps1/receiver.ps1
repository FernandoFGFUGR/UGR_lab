...
$remotePath = "/swap"
$localPath = "C:\Users\Usuario\Desktop\Laboratorio\Programacion-Automatizacion\ps1\Swap"
...
{
    Write-Host "Los archivos han sido recibidos correctamente."
}
else
{
    Write-Host "Ha ocurrido un error al transferir los archivos:" $transferResult.Failures[0].Message
}
